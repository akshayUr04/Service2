...
func (c *userSvcClient) CreateUser(ctx context.Context, in *CreatUserRequest, opts ...grpc.CallOption) (*CommonResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/userproto.UserSvc/CreateUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userSvcClient) UpdateUser(ctx context.Context, in *UpdateUserRequest, opts ...grpc.CallOption) (*CommonResponse, error) {
	out := new(CommonResponse)
	err := c.cc.Invoke(ctx, "/userproto.UserSvc/UpdateUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userSvcClient) GetUserById(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*GetUserResponce, error) {
	...
	err := c.cc.Invoke(ctx, "/userproto.UserSvc/GetUserById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userSvcClient) DeleteUser(ctx context.Context, in *DeleteUserRequest, opts ...grpc.CallOption) (*CommonResponse, error) {
	out := new(CommonResponse)
	err := c.cc.Invoke(ctx, "/userproto.UserSvc/DeleteUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userSvcClient) GetUserData(ctx context.Context, in *GetAllUserDataReq, opts ...grpc.CallOption) (*GetAllUserDataResult, error) {
	...
	err := c.cc.Invoke(ctx, "/userproto.UserSvc/GetUserData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserSvc_CreateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/userproto.UserSvc/CreateUser",
	}
...
func _UserSvc_UpdateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/userproto.UserSvc/UpdateUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserSvc_GetUserById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/userproto.UserSvc/GetUserById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserSvc_DeleteUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/userproto.UserSvc/DeleteUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserSvc_GetUserData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/userproto.UserSvc/GetUserData",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var UserSvc_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/pb/userproto/user.proto",
}
